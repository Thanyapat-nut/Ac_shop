    ...
    <div class="container">
        <div class="row">
                    ...
                    <div class="panel-group category-products" id="accordian">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title"><a href="">เทสหน้าสินค้า</a></h4> {{-- ส่วนนี้น่าจะคล้ายๆคลิปจาร ลองหาโค้ดมาเปลี่ยน--}}
                            </div>
                        </div>
            ...
            <div class="col-sm-9 padding-right">
                        ...
                        <div class="product-image-wrapper">
                            <div class="single-products">
                                <div class="productinfo text-center">
                                    <img src="{{asset('font_end/img/c1.png')}}" alt="" style="width:100px">
                                    <h2>200 ฿</h2>
                                    <p>ตรงนี้ชื่อสินค้า(ส่วนนีหาโค้ดมาใส่คล้ายๆคลิปจาร)</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                {{-- ตรงนีิโค้ดลองดูตามคลิปจารอันนี้เป็นโค้ดส่วนที่หน้าถัดไป ที่เป็นปุ่มตัวเลข (ลบส่วนคอมเม้นนี้เอาโค้ดมาใส่)--}}
                </div>
            </div>
        </div>
    </div>
